...
<body>
	<div class="page-middle">
		<jsp:include page="../common/header.jsp?active=2"></jsp:include>
		<div id="index-content" class="pr">
			<ul class="nav nav-tabs">
				<li><a href="${ctx}/log/game/coinIncreasePage">货币增加</a></li>
				<li><a href="${ctx}/log/game/coinConsumePage">货币消耗</a></li>
				<li><a href="${ctx}/log/game/propIncreasePage">道具增加</a></li>
				<li class="active"><a href="###">道具消耗</a></li>
			</ul>
			...
			<div class="table-responsive">
				...
				<jsp:include page="../common/filter.jsp?server=1&user=1&date=1"></jsp:include>
				<div id="user-list">
				</div>
			</div>
		</div>
	...
	function findList(json, pageNo, pageSize){
		...
		purl = ctx+"/log/game/propConsumeList";
		$.ajax({
			url:purl,
			data: json,
			async:true,
