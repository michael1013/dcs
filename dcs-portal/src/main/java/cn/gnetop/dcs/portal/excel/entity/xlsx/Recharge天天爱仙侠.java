...
public class Recharge天天爱仙侠 extends CommonRecharge {

	private static final long serialVersionUID = -3355539330629548062L;

	public Recharge天天爱仙侠(String gameid, Map<String, Object> map, String file, Integer sheet) {
	...
	public static void main(String[] args) {
		String[] filePaths = { "D:/My Document/sdk/logs/文件夹/全民挂机-20160911/需求2：充值明细.xls" };
		for (String filePath : filePaths) {
			for (int i = 0; i < 1; i++) {
				List<? extends CommonRecharge> list = ParseXlsxFile.read(filePath, "4002001024", Recharge天天爱仙侠.class,
				        "UTF-8", i);
