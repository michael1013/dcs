...
public class Recharge军师救我 extends CommonRecharge {

	private static final long serialVersionUID = -3355539330629548062L;

	public Recharge军师救我(String gameid, String value, String file) {
	...
	public static void main(String[] args) {
		String[] filePaths = { "C:/Users/luke/Documents/logs/军师救我csv" };
		for (String filePath : filePaths) {
			List<? extends CommonRecharge> list = ParseCsvFile.read(filePath, "4002001015", Recharge军师救我.class);
