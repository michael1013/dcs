...
public class Recharge关门放吕布 extends CommonRecharge {

	private static final long serialVersionUID = -3355539330629548062L;

	public Recharge关门放吕布(String gameid, String value, String file) {
		...
		if (column.length == 5) {
			...
			try {
				this.logTime = DateUtils.formate(
				        DateUtils.parseDate(column[3], "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm:ss.SSSSSSSSS"));
	...
	public static void main(String[] args) {
		String[] filePaths = { "C:/Users/luke/Documents/logs/关门放吕布csv" };
		for (String filePath : filePaths) {
			List<? extends CommonRecharge> list = ParseCsvFile.read(filePath, "4002001008", Recharge关门放吕布.class);
