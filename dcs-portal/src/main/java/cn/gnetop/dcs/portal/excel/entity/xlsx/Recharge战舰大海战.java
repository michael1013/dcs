...
public class Recharge战舰大海战 extends CommonRecharge {

	private static final long serialVersionUID = -3355539330629548062L;

	public Recharge战舰大海战(String gameid, Map<String, Object> map, String file, Integer sheet) {
		if (MapUtils.isNotEmpty(map)) {
			if (map.size() == 6) {
				...
				this.userid = new BigDecimal(Double.parseDouble(String.valueOf(map.get(1)))).toPlainString();
				...
				try {
					this.logTime = DateUtils
					        .formate(DateUtils.parseDate(String.valueOf(map.get(2)), "MM/dd/yyyy HH:mm:ss",
	...
	public static void main(String[] args) {
		String[] filePaths = { "C:/Users/luke/Documents/logs/战舰大海战" };
		for (String filePath : filePaths) {
			for (int i = 0; i < 1; i++) {
				List<? extends CommonRecharge> list = ParseXlsxFile.read(filePath, "4002001048", Recharge战舰大海战.class,
				        "UTF-8", i);
