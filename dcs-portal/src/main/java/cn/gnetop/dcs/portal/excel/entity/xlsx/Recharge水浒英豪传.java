...
public class Recharge水浒英豪传 extends CommonRecharge {

	private static final long serialVersionUID = -3355539330629548062L;

	public Recharge水浒英豪传(String gameid, Map<String, Object> map, String file, Integer sheet) {
	...
	public static void main(String[] args) {
		String[] filePaths = { "C:/Users/luke/Documents/logs/水浒英豪传" };
		for (String filePath : filePaths) {
			for (int i = 0; i < 1; i++) {
				List<? extends CommonRecharge> list = ParseXlsxFile.read(filePath, "4002001042", Recharge水浒英豪传.class,
				        "UTF-8", i);
